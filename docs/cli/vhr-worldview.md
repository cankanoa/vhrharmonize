...
- SpectralMatch controls: `--spectralmatch-method`, `--spectralmatch-kwargs-json`, `--group-by-basename`, plus current `--match-*` SpectralMatch passthrough arguments such as `--match-steps`
